								...
								?>
									<tr>
										...
										<td class="text-center">
											<button class="btn btn-sm btn-success view_subject" type="button" data-id="<?php echo $row['id'] ?>" data-subject="<?php echo $row['subject'] ?>" data-description="<?php echo $row['description'] ?>">Details</button>
...
<script>
	...
	$('.view_subject').click(function() {
		uni_modal2("View Subject Details", "view_subject.php?id=" + $(this).attr('data-id'), "mid-large")
