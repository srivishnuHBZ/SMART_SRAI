...
<nav id="sidebar" class='mx-lt-5 bg-dark' style="font-size: 14px;">
		
		<div class="sidebar-list">
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-tachometer-alt "></i></span> Dashboard</a>
				<?php if($_SESSION['login_faculty_id'] <= 0): ?>
				<a href="index.php?page=courses" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-th-list "></i></span> Class Darjah</a>
                <a href="index.php?page=faculty" class="nav-item nav-faculty"><span class='icon-field'><i class="fa fa-user-tie "></i></span> Teachers</a>
				...
				<a href="index.php?page=parent" class="nav-item nav-parent"><span class='icon-field'><i class="fa fa-user-friends "></i></span>Parent</a>
				...
				<a href="index.php?page=attendance_history" class="nav-item nav-attendance_history"><span class='icon-field'><i class="fa fa-tasks "></i></span> Attendance History</a>
